...
export default function PageLogin({
    ...
    return (
        <div
            className={cx(
                "form-login",
                "w-[100px] bg-[#fff] ml-[50%] translate-x-[-50%] rounded-[10px] shadow-lg pt-[20px] px-[40px] pb-[30px]"
            )}
        >
            ...
            <div className="mt-[40px] w-[100%]">
                {isLoading ? (
                    ...
                    <button
                        className=" w-[80%] py-[8px] ml-[50%] translate-x-[-50%] bg-[#ccc] rounded-full cursor-pointer hover:opacity-[0.6] bg-gradient-to-r from-[#74ebd5] to-[#9face6] border-none text-[#fff]"
                        onClick={() => handleLogin()}
                    >
                        {slug === routes.login.label ? "Login" : "Register"}
                    </button>
