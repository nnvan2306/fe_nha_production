...
export const handleSetListComments = (listComment : IListLimit<IComment>) : IComment[] =>{
...
export const handleSetListCommentAction = (listComment : IListLimit<IComment>) : IComment[]=>{
    return listComment.items.map((item: IComment) => {
        return {
            ...item,
            listUserLike: item.LikeComments.map(
